...
try {
  for (const width of [360, 390, 430]) {
    ...
    const result = await page.evaluate(() => {
      ...
      const feature = featureCta?.getBoundingClientRect();
      return {
        ...
        featureCta: feature ? { width: feature.width, height: feature.height } : null,
        featureCount: document.querySelectorAll("#fitur .promise-list--complete article").length,
        sticky,
